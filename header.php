  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <?php 
      if(isset($_SESSION['access_token']) == null){
       echo "   <a id='myBtn'><button onclick='location.href='login.php?action=login'' class='inline-flex items-center bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0 login'>Login
    </button></a>";
      }
      else{
